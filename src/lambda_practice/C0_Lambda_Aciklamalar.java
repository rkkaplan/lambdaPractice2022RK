...
public class C0_Lambda_Aciklamalar {
    ...
    ve başka elemanlara dönüştürmemize imkan sağlar
    ...
    ---Sorted---:
    Bazı durumlarda elimizdeki veri setini belirli bir parametreye göre sıralamak isteyebiliriz.
    ...
    ---findFirst()--- =>
    İlk elemanı verir. Bu akışın ilk elemanını açıklayan bir İsteğe bağlı veya akış boşsa boş bir İsteğe bağlı döndürür.
    ...
    ---flatMap()---
     => Herhangi bir Collection’daki (Array gibi) elemanları birer birer Stream’e yerleştirir.
    ...
    *****Bir değer varsa, isPresent () true, get () ise değeri döndürecektir.
    ...
    Comparator => bir Class’tır. Compare karşılaştırmak demektir. Bazı nesneler koleksiyonuna toplam sıralama uygulayan bir karşılaştırma işlevi.
