...
public class C5_Method_Referance_String {
    ...
    public static void uzundanKisayaYaz(List<String>l){
        l.stream().sorted(Comparator.comparing(String::length).reversed()).forEach(Methods::yazString);
    }



    //S3: E ILE Baslayanlari yazdiralim
    public static void yazEileBaslayanlari(List<String>l){
